...
<header class="top">
    <div class="menu">
        ...
        <div class="search">
			...
			<input type="hidden" name="__hash__" value="e952fc048a290375281e1b7bcbbc0bb3_b297d737ff5496294e1486275fb6cd07"><input type="hidden" name="__hash__" value="d178c9b53d5eda77ceba91937427b1b2_7ff56faf019331aff9e018e2b1627da6" /></form>
        ...
        <div class="after_landing">
				<div id="u_info" class="clearfix"> 
                    ...
                    <a href="/personal/msgList" class="quick_news">消息</a>
				</div>
			</div><!--after_landing e-->
        </div>    
    </div>
...
<section class="msgListWp wp">
    ...
    <div class="titleBox">
        <ul class="tab clearfix">
            <li ><a href="/personal/msgList">好友列表</li>
            <li ><a href="/personal/msgList">与好友消息</a></li>
