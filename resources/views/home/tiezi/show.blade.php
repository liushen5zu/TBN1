...
<section class="mainWp wp clearfix">
	<section class="forumDetLeft leftWp fL">
        ...
        <!---帖子 s------>
          <dl class="dis_box_hd clearfix">
             ...
             <!--   <input type="hidden" id="reCount0" class="reCount" value="2" /> -->
                ...
                <dd class="hd_dd">
                  ...
                  <ol>
                    <li class="li_right">
                        <time>{{$tiezis->created_at}}</time>
                        @if(!Session::has('username'))     
                         @else 
                         <a class="c_f60" href="javascript:;" onclick="replayComment(this,'资源小强');return false">回复</a><input type="hidden" value="28992" class="p_id"></li>
                        @endif
                  </ol>
         ...
         <dl class="dis_box_hd clearfix">
                <input type="hidden" id="user2" class="reCount" value="402759"> <!--楼主ID-->
                ...
                <dd class="hd_dd">
                  ...
                  <!--楼主编辑更新文章 s-->
                  		...
                  		<ol>
                            ...
                            @if(!Session::has('username'))     
                             @else 
                            <a class="c_f60" href="javascript:;" onclick="replayComment(this,'托雷斯');return false">回复</a>
                            <input type="hidden" value="29006" class="p_id">
                             @endif 
                        </li>
                  		</ol>
                </dd>
...
<script type="text/javascript" charset="utf-8" src="js/buttonlite.js"></script><script type="text/javascript" charset="utf-8" src="js/bsharec0.js"></script>
