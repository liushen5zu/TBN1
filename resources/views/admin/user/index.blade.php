...
<div class="row">
				...
				<div class="span10 listing-buttons">
					...
					<a href="/user/create"><button class="btn btn-primary">添加新用户</button></a>
						   ...
						   <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                   ...
                                   <a href="/user/{{$v->id}}/edit"><button style="float:left" class="btn btn-small btn-success" href="form.html">编辑</button></a>
