...
<div class="row">
				...
				<div class="span10 listing-buttons">
					...
					<a href="/cate/create"><button class="btn btn-primary">添加新用户</button></a>
						...
						<div class="page-header">
							<div class="btn-group pull-right">
										...
										<form class="form-inline" action="/user" method="get">
											<input type="text" class="input-large" placeholder="Keyword..." value="" name="keywords">
						   ...
						   <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                   ...
                                   <a href="/cate/{{$v->id}}/edit"><button style="float:left" class="btn btn-small btn-success" href="form.html">编辑</button></a>
