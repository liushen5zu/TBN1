            	...
            	<div class="tpl-form-body tpl-form-line">
	               <form class="am-form tpl-form-line-form" method="post" action="/article/{{$article->id}}" enctype="multipart/form-data">
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="title" class="tpl-form-input" id="user-name" value="{{$article->title}}" placeholder="">
                        </div>
                    </div>
                    <div class="am-form-group">
                       ...
                       <!-- -->
                            @foreach($tag as $v)
                            <label style="font-size: 14px;font-weight: normal;margin-right: 10px;"><input type="checkbox" name="tag_id[]" value="{{$v->id}}" 
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <textarea  name="intro" rows="5">{{$article->intro}}</textarea>
                        </div>
                    </div>
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <div class="am-form-group am-form-file">
                                ...
                                <button type="button" class="am-btn am-btn-danger am-btn-sm">
                                    ...
                                    <img src="{{$article->images}}" width="80px">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <div class="am-u-sm-9">
                            <textarea class="" name="content" rows="5">{{$article->content}}</textarea>
                        </div>
                        </div>
                    </div>
