...
<form class="layui-form xbs" action="">
            ...
            <a  class="layui-btn" href="/album/create" ><i class="layui-icon"></i>添加</a>
            ...
            <form method="post" action=""></form>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td-manage">
                            <form method="get" action="/album/{{$v['id']}}/edit" style="float:left">
                            {{csrf_field()}}
                            ...
                            <form method="post" action="/album/{{$v['id']}}" style="float:left">
                            {{csrf_field()}}
                            {{method_field('DELETE')}}
