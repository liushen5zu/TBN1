 ...
 */
function l_active( id )
{
	$( '.my-sidebar' ).find('ul > li > ul').removeClass('am-in');
	$( '#'+id ).parent('ul').addClass('am-in');
	$( '#'+id ).addClass('am-list1');
}
/**
 * 检测来源判断是否是手机访问
