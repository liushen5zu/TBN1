...
<title>您访问的网页不存在,发生404错误_大众影评网</title>
<meta name="description" content="这是404错误页面,您访问的网址有误或者页面已被管理员删除,5秒后将自动返回大众影评网首页,欢迎继续浏览其他内容" />
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<style>
 body{background:url(../Images/404_bg.jpg) repeat;}
</style>
<center id="main_404">
	<img src="/Images/404.jpg" style="padding:20px 0;" />
    <h1><a id="index_link" href="/" title="大众影评网" style="font-size:14px; color:#f60;">5秒后将自动,返回首页</a></h1>
    
</center>
<script>
	//mouchun.xiao 20150104
	window.onload=function(){
			var windowH = window.innerHeight || document.documentElement.clientHeight,
			 	headH = document.getElementById("main_404") ? document.getElementById("main_404").offsetTop :0,
			    footerH = document.getElementById("footer") ? document.getElementById("footer").offsetHeight:0,
			    main_404H = document.getElementById("main_404").offsetHeight,
			    H = Math.floor(windowH-headH-footerH -main_404H);
			if(H>0){
				document.getElementById("main_404").style.margin=Math.floor(H/2)+"px";
			}
			//parseInt()
			var secondsNum = parseInt(document.getElementById("index_link").innerHTML.substring(0,1));
			var index_link = document.getElementById("index_link");
			
			var _setInterval = setInterval(function(){
				if(secondsNum>0){
					secondsNum--;
					index_link.innerHTML=secondsNum+index_link.innerHTML.replace(/^./,'');	
				}else{
...
<!-- 隐藏信息  --> 
<input type='hidden' id='txt_header_url' value="http://www.51oscar.com" />
<input type='hidden' id='txt_public_home' value="/Public/Home/" module="Js" ie_page="/movie/ie.html"  baidu_page="/movie/baidu.html" qvod_page="/movie/qvod.html" gvod_page="/movie/gvod.html"  loading_page="/movie/loading.html" />
